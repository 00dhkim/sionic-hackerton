...
행사 주제인 Agents에 걸맞게 거의 모든 구현과 데이터 수집, 구축을 Geimini CLI로 했습니다. 특히 주최자이신 Sionic AI의 Storm parse부터 neo4j 그래프 구축까지 처음 배우는 기술이 많았기에, 최대한 에이전트에게 사용법만 주고 구현하라고 거의 다 맡겼습니다. 그 덕에 약 5시간의 단기간 내에 개발할 수 있었습니다.
